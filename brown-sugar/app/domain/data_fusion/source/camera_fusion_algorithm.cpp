...
static void LogOneVehicleInfo(const CDD_Fusion_ObjInfo_Array40& vehicles, const uint32_t num);
...
void CameraFusionAlgo::ExecuteCameraDataFusion()
{
    ...
    uint32_t i=ADAS_GSENTRY_OBJ_VEHI_NUM;
...
#endif
    memset(&fusion.cddObjects[0], 0, sizeof(CDD_Fusion_ObjInfo_Array40));
...
void LogOneVehicleInfo(const CDD_Fusion_ObjInfo_Array40& vehicles, const uint32_t num)
{
